...
{
	SpriteInfo drawers[] = {
		{ IID_PLAYER		   , 0, "dig1.tga", "PLAYER" },
		{ IID_PLAYER		   , 1, "dig2.tga", "PLAYER" },
		{ IID_PLAYER		   , 2, "dig3.tga", "PLAYER" },
		{ IID_PLAYER		   , 3, "dig4.tga", "PLAYER" },
		{ IID_PROTESTER, 0, "protester1.tga", "PROTESTER" },
		{ IID_PROTESTER, 1, "protester2.tga", "PROTESTER" },
		{ IID_PROTESTER, 2, "protester3.tga", "PROTESTER" },
		{ IID_HARD_CORE_PROTESTER, 0, "hardcore1.tga", "HARD_CORE_PROTESTER" },
		{ IID_HARD_CORE_PROTESTER, 1, "hardcore2.tga", "HARD_CORE_PROTESTER" },
		{ IID_HARD_CORE_PROTESTER, 2, "hardcore3.tga", "HARD_CORE_PROTESTER" },
		{ IID_HARD_CORE_PROTESTER, 3, "hardcore4.tga", "HARD_CORE_PROTESTER" },
		{ IID_WATER_SPURT, 0, "water1.tga", "WATER_SPURT" },
		{ IID_WATER_SPURT, 1, "water2.tga", "WATER_SPURT" },
		{ IID_WATER_SPURT, 2, "water3.tga", "WATER_SPURT" },
		{ IID_BARREL , 0, "barrel.tga", "BARREL" },
		{ IID_GOLD, 0, "gold.tga", "GOLD" },
		{ IID_SONAR, 0, "sonar.tga", "SONAR" },
		{ IID_WATER_POOL , 0, "waterpool.tga", "WATER_POOL" },
		{ IID_ICE, 0, "ice.tga", "ICE" },
		{ IID_BOULDER, 0, "rock1.tga", "ROCK" },
		{ IID_BOULDER, 1, "rock2.tga", "ROCK" },
		{ IID_BOULDER, 2, "rock3.tga", "ROCK" },
		{ IID_BOULDER, 3, "rock4.tga", "ROCK" },
	};
